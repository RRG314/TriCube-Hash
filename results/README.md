...
This directory contains concise public-facing result summaries, not raw archive dumps.
...
- `raw/practrand-1gb-summary-2026-05-19.md` summarizes the most important saved external-battery warning.
